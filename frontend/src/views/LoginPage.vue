  ...
  <ion-page>
    <ion-header>
      <ion-toolbar color="secondary">
        <ion-title class="text-center font-semibold">Aviation Information System</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content :fullscreen="true">
      <div class="min-h-screen flex items-center justify-center px-4 py-8 bg-gradient-to-br from-aviation-white to-gray-50">
